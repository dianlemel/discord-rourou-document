...
| `!assign @使用者 <頻道名稱>` | 工單派工（工單頻道內使用） | `!assign @John 網站設計` |
| `!portal_setup [按鈕文字]` | 發送會員中心面板 | `!portal_setup` 或 `!portal_setup 個人專區` |
...
| 選單路徑 | 功能 |
|----------|------|
| 設定 > 一般設定 > Discord | Bot Token、點數單價、金流設定、公告頻道、群發權限、禮物面板權限、點數面板權限、綁定面板權限、會員中心 OAuth2 設定 |
